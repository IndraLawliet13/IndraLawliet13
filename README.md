...
<p align="center">
  Backend APIs • Automation Workflows • Python/JS Tooling
</p>
...
- Backend API development with clean project structure
- Automation scripts and workflow tooling
- Telethon-based and browser-assisted automation experiments
- Utility libraries for API clients and developer workflows
- Trading and data-oriented research projects
